...
do
    mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi 0 -chi 0 -hkl 111
    mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi 0 -chi 0 -hkl 004
    wait
    for i in {01..10}
    do
        mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi 0.00${i} -chi 0 -hkl 111
        wait
        mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi 0.00${i} -chi 0 -hkl 004
        wait
        mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi -0.00${i} -chi 0 -hkl 111
        wait
        mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} -phi -0.00${i} -chi 0 -hkl 004
