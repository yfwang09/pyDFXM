...
do
    mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} --scale_cell 0.5 -phi 0 -chi 0 -hkl 111
    mpirun -np 20 python3 test_diamond_DFXM_mpi_workflow.py --casename ${case} --scale_cell 0.5 -phi 0 -chi 0 -hkl 004
done
